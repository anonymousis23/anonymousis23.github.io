...
for i in range(num_sets):
    ...
    mos_test_fpath.write("\t\t\t" + "<td><strong>QuestionID</strong></td>" + "\n")
    mos_test_fpath.write("\t\t\t" + "<td><strong>&nbsp; &nbsp;Clip &nbsp;&nbsp;</strong></td>" + "\n")
    mos_test_fpath.write("\t\t\t" + "<td><strong>Not at all confident</strong></td>" + "\n")
    mos_test_fpath.write("\t\t\t" + "<td><strong>&nbsp; &nbsp;| &nbsp;&nbsp;</strong></td>" + "\n")
    mos_test_fpath.write("\t\t\t" + "<td><strong>Somewhat confident</strong></td>" + "\n")
    mos_test_fpath.write("\t\t\t" + "<td><strong>&nbsp; &nbsp;| &nbsp;&nbsp;</strong></td>" + "\n")
    mos_test_fpath.write("\t\t\t" + "<td><strong>Quite a bit confident</strong></td>" + "\n")
    mos_test_fpath.write("\t\t" + "</tr>" + "\n")
